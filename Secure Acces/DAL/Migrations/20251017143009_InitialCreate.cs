    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccessMethodId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessMethods", x => x.AccessMethodId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoorNumber = table.Column<double>(type: "float", nullable: true),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LocationId = table.Column<int>(type: "int", nullable: true),
                    AccessMethodId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditLogs", x => x.AuditLogId);
                    table.ForeignKey(
                        name: "FK_AuditLogs_AccessMethods_AccessMethodId",
                        column: x => x.AccessMethodId,
                        principalTable: "AccessMethods",
                        principalColumn: "AccessMethodId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_AccessMethodId",
                table: "AuditLogs",
